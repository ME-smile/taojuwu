...
import 'package:taojuwu/view/order/widgets/order_attr_card.dart';
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      // ),
                                      buildOrderInfoBar(context, '下单人',
                                          model?.userName ?? ''),
                                      buildOrderInfoBar(context, '客户名',
                                          model?.clientName ?? ''),
                                      buildOrderInfoBar(context, '下单门店',
                                          model?.shopName ?? ''),
                                    ],
                                  ),
                                ),
