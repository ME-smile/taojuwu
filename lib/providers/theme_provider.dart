...
class ThemeProvider with ChangeNotifier {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    accentTextTheme: TextTheme(
      bodyText1: const TextStyle(color: TaojuwuColors.ACCENT_TEXT_COLOR),
    ...
    textTheme: TextTheme(
        ...
        bodyText1: TextStyle(color: TaojuwuColors.BODY1_COLOR),
        bodyText2: TextStyle(color: TaojuwuColors.BODY2_COLOR),
