          ...
          return Consumer<GoodsProvider>(
            builder: (BuildContext context, GoodsProvider goodsProvider, _) {
              ...
              return Scaffold(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        RouteHandler.goPreMeasureDataPage(
                                            context);
                                      },
                                      child: Row(
                                        mainAxisAlignment:
                  ...
                  bottomNavigationBar: Consumer2<GoodsProvider, ClientProvider>(
                    builder: (BuildContext context, GoodsProvider provider,
                            ...
                            Row(
                              children: <Widget>[
                                InkWell(
                                  onTap: () {
                                    if (!beforePurchase(
                                        goodsProvider, clientProvider)) return;
                                    setCartParams(goodsProvider);
                                    addCart(context, provider);
                                  },
                                  child: Container(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: UIKit.width(20),
                                          ...
                                          'data': [
                                            {
                                              ...
                                              'img': provider
                                                  ...
                                                  '',
                                              'goods_name':
                                                  provider?.goods?.goodsName,
                                              'price': provider?.goods?.price,
                                              'wc_attr': wrapper,
                                              'attr': jsonEncode(map),
                                              'measure_id':
                                                  provider?.measureId ?? '',
                                              'sku_id': provider?.goods?.skuId,
                                              'goods_id':
                                                  provider?.goods?.goodsId ??
                                                      '',
                                              'total_price':
                                                  provider?.totalPrice ?? 0.0,
                                            }
                                          ],
                                        }));
                                  },
