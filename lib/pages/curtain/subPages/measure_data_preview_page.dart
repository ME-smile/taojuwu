...
class MeasureDataPreviewPage extends StatelessWidget {
  ...
  void reset(OrderProvider provider) {
    if (provider?.hasChangedOpenMode == true) {
      provider?.openMode = provider?.oldOpenMode;
      provider?.oldOpenMode = null;
    }
  }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child:
                              buildText('窗型:${measureData?.windowType ?? ''}'),
                        ),
                        Divider(
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(dy != measureData?.verticalGroundHeight
                                      ? '(原${dy}cm)'
                                      : ''),
                                  InkWell(
                                    child: Icon(
                              ...
                              Row(
                                children: <Widget>[
                                  buildText(
                                      '打开方式:${measureData?.openType ?? ''}'),
                                  Text(provider?.hasChangedOpenMode == true
                                      ? '(原${provider?.oldOpenMode ?? ''})'
                                      : ''),
                                  InkWell(
                                    child: Icon(
                                      ZYIcon.edit,
                        ...
                        Container(
                          // alignment: Alignment.centerLeft,
                          child:
                              buildText('测量备注记录:${measureData?.remark ?? ''}'),
                        ),
                        Divider(
                          indent: UIKit.width(20),
                          endIndent: UIKit.width(20),
